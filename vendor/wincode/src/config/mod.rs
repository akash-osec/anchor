...
use {
    crate::{
        float_encoding::{AllowNaN, FloatEncoding as FloatEncodingPolicy},
...
pub trait ConfigCore: 'static + Sized {
    ...
    type FloatEncoding: FloatEncodingPolicy;
}
...
where
    B: ByteOrder,
    I: IntEncoding<B>,
    FloatEncoding: FloatEncodingPolicy,
{
    const PREALLOCATION_SIZE_LIMIT: Option<usize> =
    ...
    type ByteOrder = B;
    type IntEncoding = I;
    type FloatEncoding = FloatEncoding;
}
...
impl<
        ...
        F,
    > Config
    for Configuration<ZERO_COPY_ALIGN_CHECK, PREALLOCATION_SIZE_LIMIT, LengthEncoding, B, I, T, F>
where
    LengthEncoding: SeqLen<Self>,
    T: TagEncoding<Self>,
    B: ByteOrder,
    I: IntEncoding<B>,
    F: FloatEncodingPolicy,
{
